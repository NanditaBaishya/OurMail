...
<div class="container">
  <form action="" onsubmit="acknowledge()" method='post'>
  <div class="row">
    <div class="col-25">
      <label for="email">E-mail</label>
    </div>
    <div class="col-75">
      <input type="text" id="email" name="getEmail" placeholder="Enter recepient email-id...">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="header" name="getHeader" placeholder="Enter the subject name...">
    </div>
  </div>  
  <div class="row">
    <div class="col-25">
